...
void solve() {
    ...
    while(q--) {
        ...
        int ele = st.get(l, r).ele;
        int f = ele == -1 ? 0 : upper_bound(all(idx[ele]), r) - lower_bound(all(idx[ele]), l);
