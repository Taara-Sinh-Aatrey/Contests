...
void solve() {
    ...
    cin >> a;
    sort(all(a));
    int mng = *min_element(a.begin(), a.begin() + n), mnb = *min_element(a.begin() + n, a.end());
    int two_x = min(2 * mng, mnb);
    double three_x = (double) two_x * 1.5;
    double ans = three_x * n;
    amin(ans, (double) w);
